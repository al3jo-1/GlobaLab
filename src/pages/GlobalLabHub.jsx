  ...
  const services = [
    {
      ...
      title: t('globallab.trading.title', { defaultValue: 'Trading Lab' }),
    ...
    },
    {
      ...
      title: t('globallab.accounting.title', { defaultValue: 'Accounting Lab' }),
    ...
    },
    {
      ...
      title: t('globallab.business.title', { defaultValue: 'Business Lab' }),
