...
import { Calculator, ArrowLeft, Moon, Sun, Sparkles } from 'lucide-react';
import LanguageSelector from '@/components/LanguageSelector';
import { useTradingContext } from '@/contexts/TradingContext';

const AccountingComingSoon = () => {
  ...
  return (
    <div className="min-h-screen accounting-bg">
      ...
      <section className="min-h-screen flex items-center justify-center px-4 pt-16">
        ...
        >
          <Card className="bg-slate-800/50 backdrop-blur-sm border-2 border-emerald-500/20">
            <CardHeader className="text-center pb-8">
              ...
              <CardTitle className="text-4xl md:text-5xl font-bold text-white mb-4">
                {t('coming_soon.accounting.title', { defaultValue: 'Accounting Lab' })}
              </CardTitle>
              <CardDescription className="text-xl text-slate-300">
                {t('coming_soon.accounting.subtitle', { 
                  defaultValue: 'Análisis de Estados Financieros' 
                })}
              </CardDescription>
            </CardHeader>
            <CardContent className="text-center space-y-6">
              ...
              <p className="text-slate-300 text-lg max-w-2xl mx-auto">
                {t('coming_soon.accounting.description', { 
                  defaultValue: 'Estamos desarrollando una experiencia completa de aprendizaje en contabilidad y análisis financiero. Pronto podrás analizar balances, estados de resultados y flujos de efectivo en un entorno simulado.' 
                })}
              </p>
              <div className="pt-6">
                <Button
      ...
      {/* Footer */}
      <footer className="fixed bottom-0 left-0 right-0 py-4 px-4 border-t border-emerald-500/20 bg-slate-900/80 backdrop-blur-md">
...
export default AccountingComingSoon;
