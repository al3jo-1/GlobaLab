          ...
          <Card className="bg-slate-800/50 backdrop-blur-sm border-2 border-violet-500/20">
            <CardHeader className="text-center pb-8">
              <motion.div
                ...
                className="w-24 h-24 mx-auto mb-6 rounded-2xl bg-gradient-to-br from-violet-500/20 to-purple-500/20 flex items-center justify-center border-2 border-violet-500/30"
              >
