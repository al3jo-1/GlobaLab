...
export const TradingProvider = ({ children }) => {
  ...
  const initialSymbols = [
    ...
    { id: 'ECOPETROL', name: 'Ecopetrol', price: 0, change: 0, currency: 'COP', type: 'stock', baseVolatility: 0.015 },
    { id: 'BANCOLOMBIA', name: 'Bancolombia', price: 0, change: 0, currency: 'COP', type: 'stock', baseVolatility: 0.01 },
    { id: 'PFBCOLOM', name: 'Bancolombia Pref.', price: 0, change: 0, currency: 'COP', type: 'stock', baseVolatility: 0.011 },
    { id: 'GRUPOARGOS', name: 'Grupo Argos', price: 0, change: 0, currency: 'COP', type: 'stock', baseVolatility: 0.012 },
    { id: 'GRUPOSURA', name: 'Grupo Sura', price: 0, change: 0, currency: 'COP', type: 'stock', baseVolatility: 0.011 },
    { id: 'PFGRUPSURA', name: 'Grupo Sura Pref.', price: 0, change: 0, currency: 'COP', type: 'stock', baseVolatility: 0.01 },
    { id: 'ISA', name: 'ISA', price: 0, change: 0, currency: 'COP', type: 'stock', baseVolatility: 0.013 },
    { id: 'CEMARGOS', name: 'Cementos Argos', price: 0, change: 0, currency: 'COP', type: 'stock', baseVolatility: 0.014 },
    { id: 'CORFICOLCF', name: 'Corficolombiana', price: 0, change: 0, currency: 'COP', type: 'stock', baseVolatility: 0.012 },
    { id: 'GRUPOAVAL', name: 'Grupo Aval', price: 0, change: 0, currency: 'COP', type: 'stock', baseVolatility: 0.009 },
    { id: 'CELSIA', name: 'Celsia', price: 0, change: 0, currency: 'COP', type: 'stock', baseVolatility: 0.013 },
    { id: 'GRUPONUTRESA', name: 'Grupo Nutresa', price: 0, change: 0, currency: 'COP', type: 'stock', baseVolatility: 0.01 },
    { id: 'EXITO', name: 'Almacenes Éxito', price: 0, change: 0, currency: 'COP', type: 'stock', baseVolatility: 0.018 },
    { id: 'DAVIVIENDA', name: 'Davivienda Pref.', price: 0, change: 0, currency: 'COP', type: 'stock', baseVolatility: 0.011 },
    { id: 'MINEROS', name: 'Mineros S.A.', price: 0, change: 0, currency: 'COP', type: 'stock', baseVolatility: 0.022 },
